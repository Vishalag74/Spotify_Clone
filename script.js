...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        let displayName = song.replaceAll("%20", " ").replace(/\.mp3$/i, "");
        songUL.innerHTML = songUL.innerHTML + `<li data-filename="${song}"><img class="invert" width="34" src="img/music.svg" alt="">
                            <div class="info">
                                <div> ${displayName}</div>
                            </div>
                            <div class="playnow">
